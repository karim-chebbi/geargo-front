...
export default function CarDescription() {
  ...
  return (
    <div className="bg-white">
      <div className="mx-auto px-4 md:px-16 mt-16 lg:px-24">
        <Button onClick={() => navigate(-1)} icon={<LeftOutlined />}>
          Back
        </Button>
      </div>
      <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-x-8 gap-y-16 px-4 py-16 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
        <div>
